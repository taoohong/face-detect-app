...
predictor = dlib.shape_predictor(
    '/Users/taohong/Programs/course-projects/face-detect/face_recognition/data/data_dlib/shape_predictor_68_face_landmarks.dat')

# Dlib Resnet 人脸识别模型, 提取 128D 的特征矢量 / Use Dlib resnet50 model to get 128D face descriptor
face_reco_model = dlib.face_recognition_model_v1(
    "/Users/taohong/Programs/course-projects/face-detect/face_recognition/data/data_dlib/dlib_face_recognition_resnet_model_v1.dat")


class Face_Recognizer:
    def __init__(self):
        self.font = cv2.FONT_ITALIC
        self.font_chinese = ImageFont.truetype("/Users/taohong/Programs/course-projects/face-detect/face_recognition/simsun.ttc", 30)
    ...
    def get_face_from_csv(self):
        if os.path.exists("/Users/taohong/Programs/course-projects/face-detect/face_recognition/data/features_all.csv"):
            path_features_known_csv = "/Users/taohong/Programs/course-projects/face-detect/face_recognition/data/features_all.csv"
            ...
            logging.warning("Please run 'face_register.py' "
                            "and 'features_extraction_to_csv.py' before 'face_recognizer.py'")
            return 0

    def get_face_from_database(self):
        pass
    ...
    def draw_name(self, img_rd):
        ...
        draw.text(xy=self.current_frame_face_position_list[0], text=self.current_frame_name_list[0],
    ...
    def prepare(self):
        ...
        self.get_face_from_csv()

    # 处理获取的视频流, 进行人脸识别 / Face detection and recognition with OT from input video stream
